...
function _allCode() {
    ...
    */
    ...
    async function eventCAPSLOCK_parlement(message) {
        ...
        blacklist_chars = [
            `𝐄`,`𝐚`,`𝐬`,`𝐲`,`𝐥`,`𝐞`,`𝐜`,`𝐡`,`𝐚`,`𝐥`,`𝐥`,`𝐞`,`𝐧`,`𝐠`,`𝐞`,`𝐞`,`𝐧`,`𝐟`,`𝐚`,`𝐢`,`𝐭`,`𝐞`,`𝐃`,`𝐨`,`𝐦`,`𝐦`,`𝐚`,`𝐠`,`𝐞`,`𝐦`,`𝐚`,`𝐢`,`𝐬`,`𝐣`,`𝐞`,` `,`𝐩`,`𝐚`,`𝐫`,`𝐥`,`𝐞`,` `,`𝐪`,`𝐮`,`𝐚`,`𝐧`,`𝐝`,` `,`𝐦`,`𝐞`,`𝐦`,`𝐞`,` `,`𝐞`,`𝐧`,` `,`𝐦`,`𝐢`,`𝐧`,`𝐮`,`𝐬`,`𝐜`,`𝐮`,`𝐥`,`𝐞`,`.`,` `,`𝐃`,`𝐨`,`𝐧`,`𝐜`,` `,`𝐬`,`𝐢`,` `,`𝐮`,`𝐧`,`𝐞`,` `,`𝐢`,`𝐝`,`𝐞`,`𝐞`,` `,`𝐦`,`𝐞`,` `,`𝐯`,`𝐢`,`𝐞`,`𝐧`,`𝐭`,` `,`𝐣`,`𝐞`,` `,`𝐟`,`𝐞`,`𝐫`,`𝐚`,`𝐢`,`𝐬`,` `,`𝐮`,`𝐧`,` `,`𝐭`,`𝐞`,`𝐬`,`𝐭`
        ]
        ...
        */
        ...
        function isThereBlacklistedChar(text) {
            for(let i in blacklist_chars) {
                if(text.includes(blacklist_chars[i])) return true
            }
            return false
        }
